...
%>
 <%
 String relativePath = "img/review/";
 String realPath = "/Library/Tomcat/webapps/ROOT/MogaStyle/img/review"; // 저장할 디렉토리 (절대경로)
  ...
  try {
    ...
    String query = "update reservation set reviewPhoto = ? ,reviewScore = ? ,reviewContent = ? where no = ?";
