...
%>
 ...
 String realPath = "/Library/Tomcat/webapps/ROOT/MogaStyle/img/diary"; // 저장할 디렉토리 (절대경로)
  ...
  try {
    ...
    String hairLength = multi.getParameter("hairLength");
    hairLength = new String(hairLength.getBytes("8859_1"),"utf-8");
    ...
    String query = "insert into hair_diary(titleImage,styleTitle , styleLength , submitDate , user_no) values ( ? , ? , ? ,curdate(), ?)";
    psmt = conn.prepareStatement(query);

    psmt.setString(1, filename);
    psmt.setString(2,title);
    psmt.setString(3,hairLength);
    psmt.setString(4,userNo);
