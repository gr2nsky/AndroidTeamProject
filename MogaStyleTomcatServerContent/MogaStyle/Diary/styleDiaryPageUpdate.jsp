...
%>
 ...
 String realPath = "/Library/Tomcat/webapps/ROOT/MogaStyle/img/diary"; // 저장할 디렉토리 (절대경로)
  ...
  try {
    ...
    String query = "update hair_diary_page set image = ? ,hairShop = ? ,designerName = ?, contents = ? , styleDate = ? where no = "+no;
    psmt = conn.prepareStatement(query);

    psmt.setString(1, filename);
    psmt.setString(2, hairShop);
    psmt.setString(3,designerName);
