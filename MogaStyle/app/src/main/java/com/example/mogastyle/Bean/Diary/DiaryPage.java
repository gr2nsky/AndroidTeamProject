...
public class DiaryPage {
    ...
    public DiaryPage(int no, String image, String styleDate, String hairShop, String designerName, String contents) {
        this.no = no;
        this.image = image;
    ...
    public DiaryPage(int no, String image, String styleDate, String hairShop, String designerName) {
        this.no = no;
        this.image = image;
        this.styleDate = styleDate;
        this.hairShop = hairShop;
